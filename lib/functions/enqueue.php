<?php
/**
 * The CSS/JS ENQUEUE functions for SKT Supermarket
 *
...
function complete_css_js() { 
	if ( !is_admin() ) {
		...
		wp_enqueue_style('complete-owl_css',get_template_directory_uri().'/assets/css/owl.carousel.css', 'owl_css' );
		wp_enqueue_script('complete_owl',get_template_directory_uri().'/assets/js/owl.carousel.js', array('jquery'), true);
