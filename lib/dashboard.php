	...
	class SKT_Complete_Notify_Admin {
		...
		public function admin_notices() {
			...
			if (!is_plugin_active('elementor/elementor.php')) {
				...
				if (!is_plugin_active('skt-themes-demo-importer/skt-themes-demo-import.php')) {
					echo '<div class="error"><p>'.esc_html('SKT Themes Demo Import plugin is a must required plugin for this theme').'</p></div>';
				}	
				
				if (!is_plugin_active('skt-themes-demo-importer/skt-themes-demo-import.php') && !is_plugin_active('skt-themes-demo-importer/skt-themes-demo-import.php')) {
...
<div class="notice notice-info sf-notice-nux is-dismissible"> <span class="sf-icon"> <?php echo '<img src="' . esc_url( get_template_directory_uri() ) . '/images/logo.png" width="250" />'; ?> </span>
  <div class="notice-content">
    <?php if (!is_plugin_active('skt-themes-demo-importer/skt-themes-demo-import.php') && !is_plugin_active('skt-themes-demo-importer/skt-themes-demo-import.php') && current_user_can( 'install_plugins' ) && current_user_can( 'activate_plugins' ) ) : ?>
    <h2>
      <?php
							/* translators: %s: Theme name */
							printf( esc_html__( 'Thank you for installing %s.', 'skt-complete' ), '<strong>SKT Supermarket</strong>' );
							?>
    </h2>
    <p> <a href="<?php echo esc_url( admin_url( 'themes.php?page=theme-options' ) ); ?>" class="button button-primary">
      <?php
								/* translators: %s: Theme name */
								printf( esc_html__( 'Get started with %s', 'skt-complete' ), 'SKT Supermarket' );
								?>
      </a> </p>
    <?php else : ?>
...
<div class="notice notice-info sf-notice-nux"> <span class="sf-icon"> <?php echo '<img src="' . esc_url( get_template_directory_uri() ) . '/images/logo.png" width="250" />'; ?> </span>
  <div class="notice-content">
    ...
    <?php if (!is_plugin_active('skt-themes-demo-importer/skt-themes-demo-import.php') && !is_plugin_active('skt-themes-demo-importer/skt-themes-demo-import.php')) {?>
    <h2>
      <?php
							/* translators: %s: Theme name */
							printf( esc_html__( 'Thank you for installing %s.', 'skt-complete' ), '<strong>SKT Supermarket</strong>' );
    ...
    <p>
      <?php
							...
							printf( esc_html__( 'To take full advantage of all the features this theme has to offer, please install and activate FIRST the %s plugin.', 'skt-complete' ), '<strong>Elementor Page Builder</strong> and then followed by <strong>SKT Themes Demo Import</strong>' );
							?>
    </p>
    <?php } ?>
    <?php if (!is_plugin_active('skt-themes-demo-importer/skt-themes-demo-import.php') && !is_plugin_active('skt-themes-demo-importer/skt-themes-demo-import.php')) {?>
    <p>
      <?php 
						...
						$sktbuilder = array('elementor','skt-themes-demo-importer');
						$sktbuilder_php = array('elementor.php','skt-themes-demo-import.php');
						$sktbuilder_title = array('Elementor Page Builder','SKT Themes Demo Import');
						...
						$pluginactivation1 = array( 
							array (
							   "slug" => 'skt-themes-demo-importer',
							   "url" => 'skt-themes-demo-import.php',
							   "title" => 'SKT Themes Demo Importer'
							)
						 );		
    ...
    <a href="<?php echo esc_url( admin_url( 'themes.php?page=skt-themes-demo-import' ) ); ?>" class="goimport"><?php echo esc_html('Import Demo Content');?></a>
    <?php  }else{
					 	?>
...
dashicons-menu-alt"></i><a href="<?php echo esc_url( admin_url( 'nav-menus.php' ) ); ?>" target="_blank"><?php echo esc_html_e('Manage Menus','complete');?></a></li>
                                    <li><i class="dashicons 
dashicons-welcome-widgets-menus"></i><a href="<?php echo esc_url( admin_url( 'customize.php?autofocus[section]=layout_section' ) ); ?>" target="_blank"><?php echo esc_html_e('Manage Site Layout','complete');?></a></li>
                                    <li><i class="dashicons 
dashicons-welcome-write-blog"></i><a href="<?php echo esc_url( admin_url( 'customize.php?autofocus[section]=singlelayout_section' ) ); ?>" target="_blank"><?php echo esc_html_e('Post & Page Layout','complete');?></a></li>
                                </ul>
                            </div>
                        </div>
                        <?php
