...
// Home Post Box Background Color
$wp_customize->add_setting( 'complete[post_bg_color]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'post_bg_color', array(
				'label' => __('Home Post Box Background Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[post_bg_color]',
			) ) );
			
// Home Post Meta Color
$wp_customize->add_setting( 'complete[post_meta_color]', array(
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'post_meta_color', array(
				'label' => __('Home Post Meta Color','complete'),
				'section' => 'general_color_section',
...
$wp_customize->add_setting( 'complete[post_title_color]', array(
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'post_title_color', array(
				'label' => __('Home Post Title Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[post_title_color]',
			) ) );
			
// Home Read More Color
$wp_customize->add_setting( 'complete[post_readmore_color]', array(
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'post_readmore_color', array(
				'label' => __('Home Read More Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[post_readmore_color]',
			) ) );

// Post Style 1 Box Background Color
$wp_customize->add_setting( 'complete[style1_bg_color]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'style1_bg_color', array(
				'label' => __('Post Style 1 Box Background Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[style1_bg_color]',
			) ) );
			
// Post Style 1 Box Title Color
$wp_customize->add_setting( 'complete[style1_title_color]', array(
	'type' => 'option',
	'default' => '#0c0c0a',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'style1_title_color', array(
				'label' => __('Post Style 1 Box Title Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[style1_title_color]',
			) ) );
			
// Post Style 1 Box Text Color
$wp_customize->add_setting( 'complete[style1_text_color]', array(
	'type' => 'option',
	'default' => '#515151',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'style1_text_color', array(
				'label' => __('Post Style 1 Box Text Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[style1_text_color]',
			) ) );

// Post Style 2 Box Background Color
$wp_customize->add_setting( 'complete[style2_bg_color]', array(
	'type' => 'option',
	'default' => '#ffffff',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'style2_bg_color', array(
				'label' => __('Post Style 2 Box Background Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[style2_bg_color]',
			) ) );	
			
// Post Style 2 Title Color
$wp_customize->add_setting( 'complete[style2_title_color]', array(
	'type' => 'option',
	'default' => '#282828 ',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'style2_title_color', array(
				'label' => __('Post Style 2 Title Color','complete'),
				'section' => 'general_color_section',
				'settings' => 'complete[style2_title_color]',
			) ) );	
