...
$wp_customize->add_setting( 'complete[nav_bg_color_id]', array(
	'type' => 'option',
	'default' => '#9be4c4',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'nav_bg_color_id', array(
				'label' => __('Nav Button Background Color','complete'),
				'section' => 'slider_section',
				'settings' => 'complete[nav_bg_color_id]',
			) ) );
...
// Slide Font Typography And Colors
	...
	$wp_customize->add_setting('complete[slide_desc1]', array(
		'type' => 'option',
		'default'	=> __('A morning without Coffee is like sleep','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
