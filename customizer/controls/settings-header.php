...
$wp_customize->add_setting('complete[phntp_text_id]', array(
	'type' => 'option',
	'default' => __('<i class="fa fa-phone" aria-hidden="true"></i> Call : +1 234 567 890','complete'),
...
$wp_customize->add_setting('complete[sintp_text]', array(
	'type' => 'option',
	'default' => __('[social_area][social icon="facebook" link="#"][social icon="google-plus" link="#"][social icon="twitter" link="#"][social icon="linkedin" link="#"][/social_area]','complete'),
	'sanitize_callback' => 'wp_kses_post',
	'transport' => 'postMessage',
) );
...
$wp_customize->add_setting( 'complete[head_info_color_id]', array(
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'head_info_color_id', array(
				'label' => __('Header Top Bar Background Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[head_info_color_id]',
			) ) );

//HEADER INFO BACKGROUND TRANSPARENCY
$wp_customize->add_setting( 'complete[head_info_bg_trans]', array(
	...
	$wp_customize->add_control('head_info_bg_trans', array(
		'type' => 'text',
		'label' => __('Header Top Bar Background Transparency','complete'),
		'section' => 'headheader_section',
...
$wp_customize->add_setting( 'complete[menutxt_color_active]', array(
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'menutxt_color_active', array(
				'label' => __('Menu Active Text','complete'),
				'section' => 'headheader_section',
...
// Header Bar Search Background Color
$wp_customize->add_setting( 'complete[searchbox_bg_color_id]', array(
	'type' => 'option',
	'default' => '#ffc63b',
	'sanitize_callback' => 'sanitize_hex_color',
	'transport' => 'postMessage',
			...
			$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'searchbox_bg_color_id', array(
				'label' => __('Header Bar Search Background Color','complete'),
				'section' => 'headheader_section',
				'settings' => 'complete[searchbox_bg_color_id]',
			) ) );
