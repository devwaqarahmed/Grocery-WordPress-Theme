<?php 
/**
 * The Custom Style for SKT Supermarket
 *
...
.post_block_style2{background-color:<?php echo $complete['style2_bg_color'] ?>;}
.post_block_style2 h4 a{color:<?php echo $complete['style2_title_color'] ?> !important;}

.post_block_style1, .post_block_style1:nth-child(4){background-color:<?php echo $complete['style1_bg_color'] ?>;}
.post_block_style1 h3 a{color:<?php echo $complete['style1_title_color'] ?> !important;}
.post_block_style1 p{color:<?php echo $complete['style1_text_color'] ?> !important;}

.skt-home-posts-row .skt-home-posts-inner{background-color:<?php echo $complete['post_bg_color'] ?>;}
.skt-home-posts-row .skt-home-posts-date{color:<?php echo $complete['post_meta_color'] ?>;}
.skt-home-posts-row .skt-home-posts-title a{color:<?php echo $complete['post_title_color'] ?>;}
.skt-home-posts-readmore{color:<?php echo $complete['post_readmore_color'] ?>;}

/*-----------------------------COLORS------------------------------------*/
		/*Header Color*/
		.head_inner{background-color: rgba(<?php echo complete_hex2rgb($complete['head_color_id']);?>, <?php if(empty($complete['head_transparent'])){ echo '1'; }else { echo $complete['head_bg_trans'];} ?>);}
		...
		.theme-default .nivo-directionNav a{background-color:<?php echo $complete['nav_bg_color_id']; ?>}
		...
		.social-icons a:hover{ 
			...
			color:<?php echo $complete['social_icon_hvrcolor_id']; ?> !important;
		}
		
		/* Benefit Box*/
		.benefit-box .elementor-image-box-img {background-color:<?php echo $complete['benefitbox_overlaycolor_id']; ?>;}
		.benefit-box .elementor-image-box-content{background-color:<?php echo $complete['benefitbox_titlebg_color_id']; ?>;}
		.benefit-box:hover .elementor-image-box-content{background-color:<?php echo $complete['benefitbox_hvrtitlebg_color_id']; ?>;}
		.benefit-box:hover h3 {color: <?php echo $complete['benefitbox_hvrtitle_color_id']; ?> !important;}
		
		/* Products Box*/
		.newproductgallery ul#portfolioprod li .product-button::after {background-color:rgba(<?php echo complete_hex2rgb($complete['products_overlaycolor_id']);?>, 0.8);}
		.newproductgallery ul#portfolioprod li a h5{color: <?php echo $complete['products_titlecolor_id']; ?> !important;}
		.newproductgallery ul#portfolioprod li .proinfo p{color: <?php echo $complete['products_desccolor_id']; ?> !important;}
		.newproductgallery .newproprice span.woocommerce-Price-amount{color: <?php echo $complete['products_priceccolor_id']; ?> !important;}
		.newproductgallery ul#portfolioprod li .product-button .view-all-btn a{color: <?php echo $complete['products_btntext_color_id']; ?> !important; background-color:<?php echo $complete['products_btnbg_color_id']; ?>;}
		
		
		/* Team Box Background Color */
		
		.sectionrow .cols4, .sectionrow .cols3, .sectionrow .cols2, .sectionrow .cols1{ 
			background-color:<?php echo $complete['teambox_color_id']; ?>;
		}
		
		.sectionrow .cols4:hover, .sectionrow .cols3:hover, .sectionrow .cols2:hover, .sectionrow .cols1:hover{ 
			background-color:<?php echo $complete['teambox_hvrcolor_id']; ?>;
		}
		
		.team-infobox .team-title {
			color: <?php echo $complete['teambox_txt_color']; ?> !important;
		}
		...
		{color: <?php echo $complete['teambox_txt_hvrcolor']; ?> !important;}
		
		
		/* Testimonial Box Background Color */
		
		#testimonials .item{background: <?php echo $complete['testimonialbox_bg_color']; ?>;}
		#testimonials .tm_description {color:<?php echo $complete['testimonialbox_txt_color']; ?>;}
		#testimonials .tm_description h3{color:<?php echo $complete['testimonialbox_txt_color']; ?>;}
		#testimonials .tm_info{color:<?php echo $complete['testimonialbox_name_color']; ?>;}
		#testimonials .tm_info span{color:<?php echo $complete['testimonialbox_profile_color']; ?>;}
		.owl-nav .owl-next, .owl-nav .owl-prev{background: <?php echo $complete['testimonial_pager_color_id']; ?>!important;}
		.owl-nav .owl-next:hover, .owl-nav .owl-prev:hover{background: <?php echo $complete['testimonial_activepager_color_id']; ?>!important;}
		...
		.header-extras li a{color:<?php echo $complete['menutxt_color_id'] ?>;}
...
#topmenu ul li.current-menu-item > a:link:after, #topmenu ul li.current-menu-item > a:visited:after, #topmenu ul li.current-menu-parent > a:link:after, #topmenu ul li.current_page_parent > a:visited:after, #topmenu ul li.current-menu-ancestor > a:link:after, #topmenu ul li.current-menu-ancestor > a:visited:after{content:''; border-bottom-color:<?php echo $complete['menutxt_color_active']; ?> !important;}		
		...
		.header-extras li .header-search-toggle{background-color:<?php echo $complete['searchbox_bg_color_id']; ?>;}
...
#footer .footercols1 h3::after, #footer .footercols2 h3::after, #footer .footercols3 h3::after, #footer .footercols4 h3::after{background-color: <?php echo $complete['footer_title_border_color']; ?>;}
...
.copytext{color: <?php echo $complete['copyright_txt_color']; ?>;}
